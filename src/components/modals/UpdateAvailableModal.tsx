    ...
    >
      <div className="update-modal">
        ...
        <p className="update-modal__body">
          Θέλεις να ενημερωθείς τώρα; Θα εμφανιστεί μικρή μπάρα εγκατάστασης, η
          εφαρμογή θα κλείσει και θα ξανανοίξει μόνη της. Αν δεν ανοίξει σε ~20
          δευτερόλεπτα, άνοιξέ την από το μενού Έναρξη (μην πατήσεις ξανά update).
        </p>
